...
ALTER TABLE `vouchers_detalles` 
  ...
  CHANGE `vd_variante_descripcion` `vd_variante_mensaje` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL, 
...
ALTER TABLE `entidades` ADD `ent_descripcion_publica` VARCHAR(255) NULL DEFAULT NULL AFTER `ent_color_fondo`;
