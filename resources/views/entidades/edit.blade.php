            ...
            <div class="row g-2">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="color-selector">
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#0065FA' ? 'selected' : '' }}" data-color="#0065FA" style="background-color: #0065FA"></button>
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#07378C' ? 'selected' : '' }}" data-color="#07378C" style="background-color: #07378C"></button>
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#3C66AD' ? 'selected' : '' }}" data-color="#3C66AD" style="background-color: #3C66AD"></button>
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#49B384' ? 'selected' : '' }}" data-color="#49B384" style="background-color: #49B384"></button>
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#E51281' ? 'selected' : '' }}" data-color="#E51281" style="background-color: #E51281"></button>
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#FECF44' ? 'selected' : '' }}" data-color="#FECF44" style="background-color: #FECF44"></button>
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#A2A2A1' ? 'selected' : '' }}" data-color="#A2A2A1" style="background-color: #A2A2A1"></button>
                        <button type="button" class="color-option {{ old('com_color_fondo', $entidad->ent_color_fondo)=='#FDFDFE' ? 'selected' : '' }}" data-color="#FDFDFE" style="background-color: #FDFDFE"></button>
                    </div>

                    <input type="hidden" id="selectedColor" name="com_color_fondo" value="{{ old('com_color_fondo', $entidad->ent_color_fondo) }}">
                    <br>
                </div>
