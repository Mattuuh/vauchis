...
$(document).ready(function () {
    function cargar_colecciones(page = 1, orderby = '')
    {
        let dataString = $('#formftro').serialize()+'&page='+page+'&orderby='+orderby;
        $.ajax({
            type: 'GET',
            url: '/admin/colecciones/listado',
            data: dataString,
            beforeSend: function() {
                $('#box-espere').show();
            },
    ...
    cargar_colecciones($('#pag').val(), $('#ob').val());
...
<main class="commerce-page">
    ...
    <section class="commerce-hero">
        <div class="commerce-hero__content">
            <h1 class="commerce-title">Colecciones</h1>
            ...
            <div class="commerce-card">
                <div class="commerce-toolbar">
                    <div class="commerce-toolbar__left">
                        <form action="" id="formftro">
                            ...
                            <div class="commerce-search">
                                ...
                                <input type="text" class="form-control" id="buscar" name="buscar" placeholder="Buscar coleccion...">
                            </div>
                    ...
                    <div class="commerce-toolbar__right">
                        ...
                        <a href="{{ route('admin.colecciones.create') }}" class="btn commerce-new-btn"><i class="bi bi-plus-lg"></i>Nueva coleccion</a>
                    </div>
                </div>
                            ...
                            @foreach($colecciones as $coleccion)
                                <tr class="commerce-row">
                                    ...
                                    <td class="commerce-col text-center" data-label="Fecha de alta">
                                        ...
                                        <span>{{ $coleccion->colecc_fecha_alta->format('d/m/Y') }}</span>
                                    </td>
                ...
                <div class="commerce-footer">
                    <div class="commerce-footer__text">
                        Mostrando 1 a {{ $colecciones->count() }} de {{ $colecciones->count() }} registros
                    </div>
                </div>
            </div>
        </div>
