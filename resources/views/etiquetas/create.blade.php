...
<div class="container">
    ...
    <section class="vch-hero">
        <div class="vch-hero__content">
            <h1 class="vch-title">Nueva etiqueta</h1>
            <p class="vch-subtitle">Sirven para identificar, agrupar y facilitar la búsqueda de vouchers dentro de la plataforma.</p>
        </div>
    </section>
