            ...
            <div class="commerce-card">
                <div class="commerce-toolbar">
                    ...
                    <div class="commerce-toolbar__right">
                        ...
                        <a href="{{ route('admin.tipos-entidad.create') }}" class="btn commerce-new-btn"><i class="bi bi-plus-lg"></i>Nuevo tipo de entidad</a>
                    </div>
                </div>
                            ...
                            @foreach($tipos as $tipo)
                                <tr class="commerce-row">
                                    ...
                                    <td class="commerce-col commerce-col--actions" data-label="Acciones">
                                        ...
                                        <a href="{{ route('admin.tipos-entidad.edit', $tipo->tipo_ent_id) }}" class="btn commerce-edit-btn" title="Editar">
