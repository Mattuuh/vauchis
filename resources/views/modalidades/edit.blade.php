                        ...
                        <div class="campo-dinamico-item border rounded p-3 mb-3 position-relative" data-index="{{ $i }}">
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-4">
                                    ...
                                    <input
                                        type="text"
                                        name="campos[{{ $i }}][codigo]"
                                        class="form-control field-required campo-codigo"
                                        value="{{ $campo['codigo'] ?? '' }}"
                                        placeholder="Ej: porcentaje"
                                        required
                                    >
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input
                                        ...
                                        class="form-control field-required"
                                        value="{{ $campo['label'] ?? '' }}"
                                        placeholder="Ej: Porcentaje de descuento"
                                        required
                                    >
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input
                                        type="text"
                                        name="campos[{{ $i }}][placeholder]"
                                        class="form-control"
                                        value="{{ $campo['placeholder'] ?? '' }}"
                                        placeholder="Ej: Ingresá el porcentaje"
                                    >
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        <input
                                            ...
                                            type="checkbox"
                                            name="campos[{{ $i }}][requerido]"
                                            value="1"
                                            {{ !empty($campo['requerido']) ? 'checked' : '' }}
                                        >
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        <input
                                            class="form-check-input"
                                            type="checkbox"
                                            name="campos[{{ $i }}][estado]"
                                            value="1"
                                            {{ !isset($campo['estado']) || !empty($campo['estado']) ? 'checked' : '' }}
                                        >
                                        <label class="form-check-label">Sí</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        value="{{ $campo['ayuda'] ?? '' }}"
                                        placeholder="Ej: Valor entre 1 y 100"
                                    >
                                </div>
                            </div>
                        </div>
