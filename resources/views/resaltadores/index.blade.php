...
$(document).ready(function () {
    function cargar_resaltadores(page = 1, orderby = '')
    {
    ...
    cargar_resaltadores($('#pag').val(), $('#ob').val());
...
<main class="commerce-page">
    ...
    <section class="commerce-hero">
        <div class="commerce-hero__content">
            <h1 class="commerce-title">Resaltadores</h1>
            ...
            <div class="commerce-card">
                            ...
                            @foreach($resaltadores as $resaltador)
                                <tr class="commerce-row">
                                    ...
                                    <td class="commerce-col text-center" data-label="Fecha de alta">
                                        ...
                                        <span>{{ $resaltador['resal_fecha_alta']->format('d/m/Y') }}</span>
                                    </td>
                ...
                <div class="commerce-footer">
                    <div class="commerce-footer__text">
                        Mostrando 1 a {{ $resaltadores->count() }} de {{ $resaltadores->count() }} registros
                    </div>
