        ...
        <div class="vch-card p-3 mb-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="color" name="f_color" id="f_color" class="form-control" value="{{ old('f_color') }}">
                </div>

                <div class="col-12">
                    <label class="form-label required-label">Color del fondo</label>
                    <input type="color" name="f_color_fondo" id="f_color_fondo" class="form-control" value="{{ old('f_color_fondo') }}">
                </div>
